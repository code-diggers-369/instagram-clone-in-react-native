...
import { TextInput, TouchableOpacity, Button, FlatList, StyleSheet, Text, View, Image } from 'react-native';
                        ...
                        { this.state.editingProfile == true ? (
                            <View style={{ alignItems: 'center', justifyContent: 'center', paddingBottom: 20, borderBottomWidth: 1}}>
                                    <TouchableOpacity onPress={ () => this.setState({editingProfile: false})}>
                                        <Text style={{fontWeight: 'bold', backgroundColor: 'red', padding: 5, color: 'white' }}>Cancel Editing</Text>
                                    </TouchableOpacity>
                                <Text>Name:</Text>
                                <TextInput 
                                    editable = {true}
